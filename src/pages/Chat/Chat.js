...
const Chat = (props) => {
  ...
  const [areas, setareas] = useState({
    ...
    previews: [
      "The term ‘postmodern’ originally described an architectural form that drew eclectically on a variety of styles and challenged the uniform rationalism of ‘modernist’ building.",
      "In addition it has become used to signify arguments in philosophy and social theory that reject the idea that there are universally valid criteria for determining truths about the world (Lyotard...",
      "One aspect of the foundations of modern ethical theories that postmodernists target in particular is the accounts of the human subject on which they rely. As with feminist critics, postmodernist...",
      "The postmodernist critique of ethical theory, however, extends beyond the critique of foundationalism.",
      "From the postmodernist point of view, it is this project that is the fundamental problem because, they argue, it is a project that seeks, ultimately, to legitimate power and control on the grounds of...",
      "Like feminist approaches, it explicitly links its ethical theorizing to challenging predominant relations of power, though it would also accuse most feminist ethics of falling into traps of...",
    ],
  });
